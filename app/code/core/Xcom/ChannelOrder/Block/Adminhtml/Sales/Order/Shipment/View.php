...
class Xcom_ChannelOrder_Block_Adminhtml_Sales_Order_Shipment_View
    extends Mage_Adminhtml_Block_Sales_Order_Shipment_View
{
    public function __construct()
    {
        ...
        if (Mage::getSingleton('admin/session')->isAllowed('sales/order/actions/emails')) {
            ...
            $message = Mage::helper('sales')->__('Are you sure you want to send Shipment email to customer?') . ' ';
