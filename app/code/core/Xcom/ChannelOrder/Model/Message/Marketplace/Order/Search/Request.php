...
class Xcom_ChannelOrder_Model_Message_Marketplace_Order_Search_Request extends Xcom_Xfabric_Model_Message_Request
{
    ...
    protected function _prepareData(Varien_Object $options = null)
    {
        $this->setMessageData(array(
            ...
            'query' => array(
                ...
                'numberItems' => $options->getNumberItems(),
                'startItemIndex' => $options->getStartItemIndex(),
                'numberItemsFound' => $options->getNumberItemsFound(),
            )
        ));
