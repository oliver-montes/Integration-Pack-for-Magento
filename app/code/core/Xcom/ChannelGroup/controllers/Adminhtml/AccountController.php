...
class Xcom_ChannelGroup_Adminhtml_AccountController extends Xcom_ChannelGroup_Adminhtml_HandleAction
{
    /**
    ...
    {
        $this->_handleName = 'ADMINHTML_ACCOUNT';
        $this->_initLayout();
        $this->_setActiveMenu('channels/account');
        $this->renderLayout();
    }
