 ...
 * @package     Xcom_Cse
 */
class Xcom_Cse_Block_Adminhtml_Channel_Edit extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    public function getHeaderText()
    {
        if ($this->getChannel()->getId()) {
            return $this->__('Edit Google Site', $this->escapeHtml($this->getChannel()->getName()));
        }
        return $this->__('New Google Site', $this->escapeHtml($this->getChannelType()->getTitle()));
    }
