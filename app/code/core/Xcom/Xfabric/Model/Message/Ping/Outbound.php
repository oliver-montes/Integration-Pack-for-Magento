...
class Xcom_Xfabric_Model_Message_Ping_Outbound extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'message/ping';
        $this->_schemaRecordName = 'Ping';
        $this->_schemaVersion  = "1.0.0";
        $this->_isOnBehalfOfTenant = false;
        /** @var $authModel Xcom_Xfabric_Model_Authorization */
        $authModel = Mage::getModel('xcom_xfabric/authorization');
        $this->_destinationId = $authModel
            ->load()
            ->getDestinationId();
    }
