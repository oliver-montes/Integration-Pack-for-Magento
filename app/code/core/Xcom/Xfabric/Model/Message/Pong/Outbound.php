...
class Xcom_Xfabric_Model_Message_Pong_Outbound extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'message/pong';
        $this->_schemaRecordName = 'Pong';
    ...
    public function _prepareData(Varien_Object $dataObject = null)
    {
        ...
        $data = array(
            'payload' => $dataObject ? $dataObject->getPayload() : null
        );
