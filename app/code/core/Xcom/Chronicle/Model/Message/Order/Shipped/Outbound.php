...
class Xcom_Chronicle_Model_Message_Order_Shipped_Outbound extends Xcom_Xfabric_Model_Message_Request
{
    ...
    {
        $result = Mage::getModel('xcom_chronicle/message_shipment', $dataObject->getShipment());
