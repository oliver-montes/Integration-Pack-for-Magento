...
class Xcom_Chronicle_Model_Message_Order_Search_Fail extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'order/searchFailed';
        $this->_schemaRecordName = 'SearchOrdersFailed';
