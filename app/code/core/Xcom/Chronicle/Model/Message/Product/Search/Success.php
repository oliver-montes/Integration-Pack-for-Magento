...
class Xcom_Chronicle_Model_Message_Product_Search_Success extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'com.x.pim.v1/ProductSearch/SearchProductSucceeded';
        $this->_schemaRecordName = 'SearchProductSucceeded';
