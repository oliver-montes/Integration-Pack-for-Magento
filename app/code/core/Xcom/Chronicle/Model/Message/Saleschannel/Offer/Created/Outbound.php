...
class Xcom_Chronicle_Model_Message_Saleschannel_Offer_Created_Outbound extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'salesChannel/offer/created';
