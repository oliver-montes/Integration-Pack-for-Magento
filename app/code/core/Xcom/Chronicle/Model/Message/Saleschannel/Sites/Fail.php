...
class Xcom_Chronicle_Model_Message_Saleschannel_Sites_Fail extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'salesChannel/site/searchFailed';
        $this->_schemaRecordName = 'SearchSiteFailed';
