...
class Xcom_Chronicle_Model_Message_Customer_Deleted_Outbound extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'customer/deleted';
        $this->_schemaRecordName = 'CustomerDeleted';
    ...
    {
        $result = array('customerId' => $dataObject->getCustomer()->getEntityId());
        $data = array(
            'customer' => $result
        );
