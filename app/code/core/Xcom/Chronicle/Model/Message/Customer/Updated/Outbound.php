...
class Xcom_Chronicle_Model_Message_Customer_Updated_Outbound extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'customer/updated';
        $this->_schemaRecordName = 'CustomerUpdated';
