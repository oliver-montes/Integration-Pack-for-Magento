...
class Xcom_Chronicle_Model_Message_Inventory_Stock_Updated_Outbound extends Xcom_Xfabric_Model_Message_Request
{
    /**
    ...
    {
        parent::_construct();
        $this->_topic = 'com.x.inventory.v1/StockItemUpdate/StockItemUpdated';
        $this->_schemaRecordName = 'StockItemUpdated';
