...
class Xcom_Chronicle_Model_Message_Inventory_Stock_Get_Fail extends Xcom_Xfabric_Model_Message_Request
{
    ...
    {
        parent::_construct();
        $this->_topic               = 'com.x.inventory.v1/StockItemLookup/LookupStockItemFailed';
        $this->_schemaRecordName    = 'LookupStockItemFailed';
