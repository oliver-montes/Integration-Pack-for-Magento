 ...
 */
class Xcom_Google_Block_Adminhtml_Product_Edit_Tab_History_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    {
        parent::__construct();
        $this->setId('xcom_google_product_tab_history_form');
        $this->setTemplate('xcom/google/product/tab/form.phtml');
    }
    ...
    {
        return $this->getUrl('*/*/history', array('id' => (int)$this->getRequest()->getParam('id')));
    }
}
