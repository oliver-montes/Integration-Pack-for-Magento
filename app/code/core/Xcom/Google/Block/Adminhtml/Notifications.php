...
class Xcom_Google_Block_Adminhtml_Notifications extends Mage_Adminhtml_Block_Template
{
    /**
    ...
    {
        return (bool)Mage::helper('xcom_google')->isXfabricRegistered()
            && !(bool)Mage::helper('xcom_google')->isExtensionEnabled();
    }
}
