...
class Xcom_Mapping_Model_Message_ProductTaxonomy_ProductType_Get_Request
    extends Xcom_Mapping_Model_Message_ProductTaxonomy_ProductType_Abstract_Request
{
    ...
    {
        parent::_construct();
        $this->_topic = 'productTaxonomy/productType/get';
        $this->_schemaRecordName = 'GetProductType';
