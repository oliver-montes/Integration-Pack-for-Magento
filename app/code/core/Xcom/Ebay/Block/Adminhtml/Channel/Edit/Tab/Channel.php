 ...
 */
class Xcom_Ebay_Block_Adminhtml_Channel_Edit_Tab_Channel extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        if (Mage::getSingleton('adminhtml/session')->getXcomEbayData()){
            $form->setValues(Mage::getSingleton('adminhtml/session')->getXcomEbayData());
            Mage::getSingleton('adminhtml/session')->setXcomEbayData(null);
        }
    ...
    {
        return Mage::getSingleton('xcom_ebay/source_site')->toOptionArray();
    }

    /**
     * Retrieve enabled and valid eBay sites array.
     *
     * @return array
     */
    protected function _getEnabledAndValidAccounts()
    {
        /** @var $source Xcom_Ebay_Model_Source_Account */
        $source = Mage::getSingleton('xcom_ebay/source_account');
        if ($this->getChannel() && !$this->getChannel()->getId()) {
            return $source->getActiveAccountHash();
        }
