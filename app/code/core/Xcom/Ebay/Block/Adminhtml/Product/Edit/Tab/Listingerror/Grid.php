 ...
 */
class Xcom_Ebay_Block_Adminhtml_Product_Edit_Tab_Listingerror_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Initialize class.
     */
    ...
    {
        parent::__construct();
        $this->setId('ebay_channel_product_listingerror_grid');
     ...
     * Prepare collection.
     *
     * @return Xcom_Ebay_Model_Resource_Channel_Listingerror_Collection
     */
    protected function _prepareCollection()
    {
        ...
        if ($productId && $responseId) {
            /* @var $listingLogResponse Xcom_Mmp_Model_Message_Listing_Log_Response */
     ...
     * @param array $items
     * @return Xcom_Ebay_Block_Adminhtml_Product_Edit_Tab_Listingerror_Grid
     */
