 ...
 */
class Xcom_Ebay_Block_Adminhtml_Product_Edit_Tab_Listingerror_Form extends Mage_Adminhtml_Block_Widget_Form
{
   /**
    ...
    {
        parent::__construct();
        $this->setId('xcom_ebay_product_tab_listingerror_form');
    }

    /**
     * Prepare product collection
     *
     * @return Xcom_Mmp_Model_Resource_Product_Collection
     */
