 ...
 */
class Xcom_Ebay_Block_Adminhtml_Product_Edit_Tab_History_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Initialize class.
     */
    ...
    {
        parent::__construct();
        $this->setId('ebay_channel_product_history_grid');
        $this->setSaveParametersInSession(true);
        $this->setEmptyText($this->__('These products have not been published to any of eBay Channels yet.'));
