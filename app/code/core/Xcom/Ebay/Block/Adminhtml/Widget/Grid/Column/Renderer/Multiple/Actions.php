 ...
 * @package    Xcom_Ebay
 */
class Xcom_Ebay_Block_Adminhtml_Widget_Grid_Column_Renderer_Multiple_Actions
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Action
{
    ...
    {
        if ($row->getResponseResult() == Xcom_Listing_Model_Channel_Product::STATUS_FAILURE) {
