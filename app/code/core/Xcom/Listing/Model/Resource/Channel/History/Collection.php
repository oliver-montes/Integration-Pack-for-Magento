...
class Xcom_Listing_Model_Resource_Channel_History_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    /**
    ...
    {
        $this->_init('xcom_listing/channel_history');
    }
    ...
    {
        $this->getSelect()
            ->joinInner(array('channel' => $this->getTable('xcom_mmp/channel')),
