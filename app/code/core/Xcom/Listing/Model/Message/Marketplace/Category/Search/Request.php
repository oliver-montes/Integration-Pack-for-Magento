...
class Xcom_Listing_Model_Message_Marketplace_Category_Search_Request extends Xcom_Xfabric_Model_Message_Request
{

    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'marketplace/category/search';
        $this->_schemaRecordName = 'SearchCategories';
    }
    ...
    {
        $data = array(
            'siteCode' => $dataObject->getData('siteCode') ? $dataObject->getData('siteCode') : 'US',
