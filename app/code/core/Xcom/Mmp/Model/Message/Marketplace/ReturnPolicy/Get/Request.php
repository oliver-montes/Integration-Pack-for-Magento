...
class Xcom_Mmp_Model_Message_Marketplace_ReturnPolicy_Get_Request extends Xcom_Xfabric_Model_Message_Request
{
    /**
    ...
    {
        parent::_construct();
        $this->_topic               = 'marketplace/returnPolicy/get';
        $this->_schemaRecordName    = 'GetReturnPolicy';
    }
