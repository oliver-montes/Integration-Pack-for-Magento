...
class Xcom_Mmp_Model_Message_Marketplace_PaymentMethod_Search_Request extends Xcom_Xfabric_Model_Message_Request
{
    /**
    ...
    {
        parent::_construct();
        $this->_topic               = 'marketplace/paymentMethod/search';
        $this->_schemaRecordName    = 'SearchPaymentMethod';
    }
