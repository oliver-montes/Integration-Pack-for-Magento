...
class Xcom_Mmp_Model_Message_Marketplace_HandlingTime_Search_Request extends Xcom_Xfabric_Model_Message_Request
{
    /**
    ...
    {
        parent::_construct();
        $this->_topic = 'marketplace/handlingTime/search';
        $this->_schemaRecordName = 'SearchHandlingTime';
    }
