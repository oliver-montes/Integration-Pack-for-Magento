...
class Xcom_CseOffer_Model_Resource_Channel_Product_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    /**
     ...
     *
     * @return Xcom_CseOffer_Model_Resource_Channel_Product_Collection
     */
    ...
    /**
     * Add table xcom_cseoffer_channel_product to join and filter by product_id
     *
     * @param $productId
     * @return Xcom_CseOffer_Model_Resource_Channel_Product_Collection
     */
    public function addChannelProduct($productId)
    {
        ...
        $select->join(array('ch' => $this->getTable('xcom_cse/channel')),
