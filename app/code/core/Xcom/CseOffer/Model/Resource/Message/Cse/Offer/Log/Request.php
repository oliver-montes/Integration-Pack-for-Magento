...
class Xcom_CseOffer_Model_Resource_Message_Cse_Offer_Log_Request extends Mage_Core_Model_Mysql4_Abstract
{
    /**
    ...
    {
        $this->_init('xcom_cseoffer/message_cse_offer_log_request', 'request_id');
    }
